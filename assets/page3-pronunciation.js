(function () {
  ...
  var audio = document.createElement('audio'); audio.className='page3-pronunciation'; audio.controls=true; audio.preload='metadata'; audio.src='./content/i18n/sw-TZ/audio/pg003_consonant_pronunciation_guide.mp3?v=20260829'; audio.setAttribute('aria-label','Mwongozo wa matamshi ya konsonanti kwa Kiswahili Tanzania');
